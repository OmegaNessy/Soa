...
public class AnswerMapper {
    ...
    public Answer toEntity(AnswerDto dto){
        return Objects.nonNull(dto) ? new Answer(dto.getId(),obtainQuestion(dto.getQuestionId()),
                dto.getScore(),dto.getAnswerText(),dto.getMembership()):null;
    }

    public AnswerDto toDto(Answer answer){
        return Objects.nonNull(answer) ? new AnswerDto(answer.getId(),answer.getQuestion().getId(),
                answer.getAnswerText(),answer.getScore(),answer.getMembership()):null;
    }
